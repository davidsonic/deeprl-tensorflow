...
class FFModel(BaseModel):
    ...
    def define_train_op(self):
        ...
        self.loss = tf.losses.mean_squared_error(self.delta_pred_normalized, self.delta_labels_normalized)# TODO(Q1) Define a loss function that takes as input normalized versions of predicted change in state and ground truth change in state
