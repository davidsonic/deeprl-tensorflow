...
class MLPPolicy(BasePolicy):
    ...
    def __init__(self,
        ...
        **kwargs):
        ...
        # saver for policy variables that are not related to training, because training part can't be used for inference
    ...
    def build_graph(self):
        ...
        if self.training: #need to train baseline and actor
